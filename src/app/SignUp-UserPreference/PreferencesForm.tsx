...
export function PreferencesForm() {
  ...
  function handleRemoveTag(category: keyof PreferencesState, index: number) {
    setPreferences((prev) => {
        ...
        <div className={styles.tags}>
          {preferences.food.map((item, index) => (
            <span key={index} className={styles.tag}>
              {item} <button className={styles.tagRemove} onClick={() => handleRemoveTag("food", index)}>✖</button>
            </span>
          ))}
        </div>
      </fieldset>
      ...
      <fieldset className={styles.category}>
        ...
        <div className={styles.tags}>
          {preferences.activities.map((item, index) => (
            <span key={index} className={styles.tag}>
              {item} <button className={styles.tagRemove} onClick={() => handleRemoveTag("activities", index)}>✖</button>
            </span>
          ))}
        </div>
      </fieldset>
      ...
      <fieldset className={styles.category}>
        ...
        <div className={styles.tags}>
          {preferences.places.map((item, index) => (
            <span key={index} className={styles.tag}>
              {item} <button className={styles.tagRemove} onClick={() => handleRemoveTag("places", index)}>✖</button>
            </span>
          ))}
        </div>
      </fieldset>
...
*/
// COMMENTED OUT IS VERSION 2 (Blue Tags with "x" to remove tags. Code Needs to routed properly with DB)
