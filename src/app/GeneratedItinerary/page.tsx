      ...
      <div className={styles.section}>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.details}>
            <h2>Cafe One</h2>
            <p>
              <strong>Tags:</strong> Cafe, Casual
            </p>
            <p>
              Cool, casual coffee bar near City College serves breakfast &amp; light fare.
            </p>
            <p>
              <strong>Address:</strong> 1619 Amsterdam Ave, New York, NY 10031
            </p>
            <p>
              <strong>Hours:</strong> Open • Closes 6 PM
            </p>
            <p>
              <strong>Phone:</strong> (212) 690-0060
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.details}>
            ...
            <p>
              <strong>Tags:</strong> Billiards, Drinks
            </p>
            <p>Billiards and sports bar in Korea town. Suitable for adults.</p>
            <p>
              <strong>Address:</strong> 34 W 32nd St Floor 12, New York, NY 10001
            </p>
            <p>
              <strong>Hours:</strong> Open • Closes 3 AM
            </p>
            <p>
              <strong>Phone:</strong> (212) 239-4166
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.details}>
            <h2>Little Island</h2>
            <p>
              <strong>Tags:</strong> Free, Park, Waterside
            </p>
            <p>
              Island park with a striking stilt design, featuring flower beds &amp; shows at a waterside.
            </p>
            <p>
              <strong>Address:</strong> Pier 55 in Hudson River Park at, W 13th St, New York, NY 10014
            </p>
            <p>
              <strong>Hours:</strong> 6 AM - 9 PM
            </p>
            <p>
